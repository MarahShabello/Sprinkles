            ...
            <div id="navigation" class="collapse navbar-collapse">
                ...
                <div class="navbar-buttons d-flex justify-content-end">
                    ...
                    <div id="basket-overview" class="navbar-collapse collapse d-none d-lg-block">
                        <a href="http://localhost/webProgramming/project/cart.php" class="btn btn-primary navbar-btn">
                            <i class="fa fa-shopping-cart"></i>
                        </a>
                    </div>
...
<div style="padding-bottom: 50px ;padding-top: 50px;   margin: auto;" onload="Acc.php">
    <div class="flex-container" >
        ...
        <div>
            ...
            <table style="margin-left: 400px">
                <tr>
                    <td>
                        <button type="button" class="btn btn-primary" style="padding-left: 5px" id="add_button"
                                data-toggle="modal" data-target="#userModal">
                            <i class="fa fa-info-circle" style="padding-right: 10px"></i>Edit Info
                        </button>
                    </td>
                    <td></td>
                    <td>
            ...
            <div class="col-lg-3" style="padding-left: 100px;">
                <div id="order-summary" class="box" style="width: 450px;">
                    <div class="box-header">
                        <h3 class="mb-0" style="color: #4fbfa8;"> Sprinkles</h3>
                    </div>
...
<div id="userModal" class="modal fade">
    <div class="modal-dialog">
        <form method="post" id="course_form" action="http://localhost/webProgramming/Sprinkles/main/Acc.php">
