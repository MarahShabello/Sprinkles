...
<header class="header mb-5">
    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="container">
            ...
            <a href="http://localhost/webProgramming/Sprinkles/main/index.php" class="navbar-brand home">
            ...
            <div class="navbar-buttons">
                ...
                <a href="http://localhost/webProgramming/Sprinkles/main/cart.php" class="btn btn-outline-secondary navbar-toggler">
            ...
            <div id="navigation" class="collapse navbar-collapse">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a href="http://localhost/webProgramming/Sprinkles/main/index.php" class="nav-link active">Home</a>
                    </li>
                    ...
                    <li class="nav-item dropdown menu-large">
                        <a href="#aboutUs" data-toggle="dropdown" data-hover="dropdown" data-delay="200" class="nav-link">About Us<b class="caret"></b></a>
                    </li>
                    <li class="nav-item dropdown menu-large">
                        <a href="#contact" data-toggle="dropdown" data-hover="dropdown" data-delay="200" class="nav-link">Contact Us<b class="caret"></b></a>
                ...
                <div class="navbar-buttons d-flex justify-content-end">
                    ...
                    <div id="basket-overview" class="navbar-collapse collapse d-none d-lg-block">
                        <a href="http://localhost/webProgramming/Sprinkles/main/cart.php" class="btn btn-primary navbar-btn">
                            <i class="fa fa-shopping-cart"></i>
                        </a>
                    </div>

                    <div id="profile" class="navbar-collapse collapse d-none d-lg-block">
                        <a href="http://localhost/webProgramming/Sprinkles/main/Acc.php" class="btn btn-primary navbar-btn">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="http://localhost/webProgramming/Sprinkles/main/index.php">Home</a></li>
                        ...
                        <div class="box">
                            <form method="post" action="">
                                ...
                                <div class="box-footer d-flex justify-content-between flex-column flex-lg-row">
                                    <div class="left">
                                        <a href="http://localhost/webProgramming/Sprinkles/main/index.php" class="btn btn-outline-secondary">
                                    ...
                                    <div class="right">
                                        <button type="submit" class="btn btn-primary">
                                            <a href="http://localhost/webProgramming/Sprinkles/main/log_out.php" style="color: #FFFFFF">
                                                Checkout
                                            </a>
                                        </button>
                                    </div>
                                ...
                                <div class="product same-height">
                                    <a href="#">
                                        <img src="pictures/macaroons/5e7928019fe6d.image.jpg" alt="" class="img-fluid" style="height: 250px;  width: 100%; object-fit: cover"
                                             ...
                                             window.location.href ='http://localhost/webProgramming/Sprinkles/main/description.php'">
                                    </a>
                                    <div class="text">
                                        <h3>Macaroon Box</h3>
                                ...
                                <div class="product same-height">
                                    <a href="#">
                                        <img src="pictures/cakes%20and%20cheesecakes/Triple-Berry-No-Bake-Cheesecake.jpg" alt="" class="img-fluid" style="height: 250px; object-fit: cover"
                                             onclick="document.cookie = 'name'+'='+'No bake cheese cake';
                                             window.location.href ='http://localhost/webProgramming/Sprinkles/main/description.php'">
                                    </a>
                                    <div class="text">
                                        <h3>Mexican chocolate pecan tart</h3>
                                        <p class="price">40.89$</p>
                                    </div>
                                </div>
                                <!-- /.product-->
                            </div>
...
if (mysqli_connect_error()) {
    ...
    $pid = "SELECT * FROM `purshased` WHERE `quantity`= '$n'";
