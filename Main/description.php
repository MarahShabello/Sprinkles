        ...
        <div class="container">
            ...
            <div id="navigation" class="collapse navbar-collapse">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown menu-large">
                        <a href="index.php#aboutUs" data-toggle="dropdown" data-hover="dropdown" data-delay="200" class="nav-link">About Us<b class="caret"></b></a>
                    </li>
                    <li class="nav-item dropdown menu-large">
            ...
            <br>
                ...
                <div class="ui vertical animated button" tabindex="0"
                    ...
                    <div class="hidden content" >
                        ...
                        ?>
                        window.location.href='http://localhost/webProgramming/Sprinkles/main/cart.php'";>
                             Add to cart
                         </a>
