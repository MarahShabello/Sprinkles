...
if(isset($_REQUEST['search'])) {
    ...
    $db = mysqli_connect("localhost", "root", "", "sprinkles");
    ...
    <div id="d" style="padding-top: 150px">
        ...
        <div class="total-frame">
            ...
            <div class="flex-container-p-menu">
                ...
                <div>
                    <p class="names" style="margin-left: 20px">Cookies & Brownies</p>
                </div>
                <div>
                    <p class="names" style="margin-left: 60px">Macaroons</p>
                </div>
                <div>
                    <p class="names" style="margin-left: 100px">Donuts</p>
                </div>
                <div>
                    <p class="names" style="margin-left: 100px">Tarts & Pies</p>
                </div>
            </div>
            ...
            <div class="flex-container-p-best">
                ...
                <div style="margin-left: 60px">
                    ...
                    <button class="addToCart" type="button" style="position: relative; width:170px" onclick="document.cookie = 'cat'+'='+'Cakes';document.cookie = 'name'+'='+'Coconut angel cake';window.location.href='description.php'">
                        Product Detail
                    </button>
                </div>
            </div>
